...
def download_manga(manga, url, source, sleep_time, chapters, auto_merge, convert_to_pdf):
    ...
    while len(chapters) > 0:
        ...
        try:
            ...
            images = source.get_images(url, chapters[0])
            adder = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', action=SetSource, required=True, help='domain to scrap from')
    ...
    single_manga_chapters.add_argument('-r', action=RangeOfChapters, nargs=2, type=float, help='\
