...
parser.add_argument('-t', action='store', default=0.1, type=float, help='set sleep time between requests')
...
search_args.add_argument('-page-limit', action='store', default=1000, type=int, help='specify how many pages should be searched')
